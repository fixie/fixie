    ...
    public class NUnit2XmlOutputListener : Listener
    {
        ...
        public void CaseSkipped(Case @case)
        {
            GetClassTestSuite(@case.Class)
                .Element("results")
                .Add(new XElement("test-case", new XAttribute("name", @case.Name), new XAttribute("executed", "False"),
        ...
        public void CaseFailed(FailResult result)
        {
            ...
            suite
                ...
                .Add(new XElement("test-case",
                    ...
                    new XElement("failure", new XElement("message", new XCData(result.PrimaryExceptionMessage())),
                        new XElement("stack-trace", new XCData(result.CompoundStackTrace()))),
                    new XAttribute("executed", "True"),
        ...
        XElement GetClassTestSuite(Type @class)
        {
            ...
            {
                ret = new XElement("test-suite", new XElement("results"), new XAttribute("name", @class.FullName), new XAttribute("success", "True"),
                    new XAttribute("time", ""));
