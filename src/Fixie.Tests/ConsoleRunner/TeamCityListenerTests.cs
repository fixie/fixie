            ...
            using (var console = new RedirectedConsole())
            {
                ...
                console.Lines()
                       ...
                       .ShouldEqual(
                           ...
                           "##teamcity[testFailed name='" + testClass + ".FailA' message='|'FailA|' failed!' details='" + At<PassFailTestClass>("FailA()") + "']",
                           ...
                           "##teamcity[testFailed name='" + testClass + ".FailB' message='|'FailB|' failed!' details='" + At<PassFailTestClass>("FailB()") + "']",
