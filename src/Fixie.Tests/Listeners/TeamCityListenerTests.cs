            ...
            using (var console = new RedirectedConsole())
            {
                ...
                console.Lines()
                       ...
                       .ShouldEqual(
                           ...
                           "##teamcity[testFailed name='" + testClass + ".FailA' details='|'FailA|' failed!|r|n   at Fixie.Tests.Listeners.TeamCityListenerTests.PassFailTestClass.FailA() in " + PathToThisFile() + ":line #']",
                           ...
                           "##teamcity[testFailed name='" + testClass + ".FailB' details='|'FailB|' failed!|r|n   at Fixie.Tests.Listeners.TeamCityListenerTests.PassFailTestClass.FailB() in " + PathToThisFile() + ":line #']",
