...
namespace Fixie.Tests.Lifecycle
{
    public abstract class LifecycleTests
    {
        ...
        protected static void ClassSetUp(Class @class)
        {
            @class.Type.ShouldEqual(typeof(SampleTestClass));
            WhereAmI();
        }

        protected static void ClassTearDown(Class @class)
        {
            @class.Type.ShouldEqual(typeof(SampleTestClass));
            WhereAmI();
        }
        ...
        protected class InstanceSetUpTearDown : InstanceBehavior
        {
            ...
            {
                InstanceSetUp(fixture);
                next();
                InstanceTearDown(fixture);
            }
        }
