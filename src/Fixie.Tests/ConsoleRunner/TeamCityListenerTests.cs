            ...
            using (var console = new RedirectedConsole())
            {
                ...
                console.Lines()
                       ...
                       .ShouldEqual(
                           ...
                           "##teamcity[testFailed name='" + testClass + ".Fail' message='|'Fail|' failed!' details='" + At<PassFailTestClass>("Fail()") + "']",
                           ...
                           "##teamcity[testFailed name='" + testClass + ".FailByAssertion' message='Assert.Equal() Failure|r|nExpected: 2|r|nActual:   1' details='" + At<PassFailTestClass>("FailByAssertion()") + "']",
